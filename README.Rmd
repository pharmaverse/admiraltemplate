...
1.  *Recommended*: Review the [documentation on the CI/CD workflows](.github/workflows/README.md) for information about how to reuse the worflows from this template. 
