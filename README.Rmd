...
* `r dyn_link("Programming strategy", admiral_homepage, "articles/programming_strategy.html")`
* `r dyn_link("Development process", admiral_homepage, "articles/development_process.html")`
